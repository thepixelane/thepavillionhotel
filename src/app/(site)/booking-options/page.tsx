...
export default async function BookingOptionsPage() {
  ...
  const directUrl = sanitizeBookingUrl(settings?.bookingEngineUrl?.trim() || defaultBookingUrl);
  ...
  return (
    <main className="mx-auto min-h-[65svh] max-w-5xl px-5 py-14 sm:py-20 lg:px-8">
      ...
      <h1 className="mt-4 text-4xl text-fg sm:text-5xl lg:text-6xl">Compare booking options</h1>
