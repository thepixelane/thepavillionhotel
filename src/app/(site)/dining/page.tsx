...
export const metadata: Metadata = createPageMetadata({
  title: "The Pavillion Restaurant in Kolhapur",
  description:
    "The Pavillion Restaurant in Kolhapur serves Mughlai, Afghani, Chinese and Continental cuisine across three seating areas: Pakhtoon, Walkway and Areca Bistro.",
  path: "/dining",
});
...
export default async function DiningPage() {
  ...
  return (
    <main className="mx-auto max-w-7xl 4xl:max-w-[90rem] px-5 py-14 sm:py-20 lg:px-8">
      ...
      <header className="max-w-3xl"><p className="text-xs uppercase tracking-[0.3em] text-emerald">Dining</p><h1 className="mt-4 text-4xl text-fg sm:text-5xl lg:text-6xl">The Pavillion Restaurant</h1><p className="mt-5 text-lg leading-8 text-fg-muted">One kitchen, one menu, three settings. Choose air-conditioned indoor dining at Pakhtoon, open-air tables along the Walkway, or a relaxed seat at Areca Bistro.</p></header>
        ...
        {diningVenues.map((place, index) => (
          <article key={place.name} className="grid overflow-hidden border border-line bg-surface lg:grid-cols-2">
            ...
            <div className="flex flex-col justify-center p-6 sm:p-10 lg:p-12">
              <p className="text-xs uppercase tracking-[0.28em] text-emerald">Seating Area</p>
